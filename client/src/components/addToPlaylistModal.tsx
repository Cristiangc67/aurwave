                    ...
                    {playlists.map(playlist => {
                        ...
                        return (
                            <li
                                ...
                                className="px-3 py-2 rounded-lg cursor-pointer hover:bg-white/10 transition-colors"
                            >
                                {containsSong ? `Eliminar de ${playlist.name}` : playlist.name}
                            </li>
                        )
                    })}
                </ul>
